import { FamilySummary as FamilySummaryType } from '@sobremesa/api-client';

interface FamilySummaryProps {
  summary: FamilySummaryType;
}

export function FamilySummary(props: FamilySummaryProps) {
    ...
    <div class="summary-container">
        ...
        <section class="summary-section">
          ...
          <ul>
            {summary().events.map((e) => (
              <li>
                {(e.date_text || e.date_year) && (
                  <span class="date">[{e.date_text || e.date_year}]</span>
                )}
                {e.event_type && (
      ...
      <footer class="summary-footer">
        <p>
          ...
          {summary().places.length} places, {summary().events.length} events •{' '}
          {summary().relationships.length} relationships,{' '}
