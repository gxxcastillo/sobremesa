...
Without warmth, people clam up. With warmth, contributions flow.

Warmth is not a "nice to have" feature - it's the fundamental mechanism that makes family history collection work. Technical accuracy means nothing if the family doesn't want to participate.
...
- Reminds people of forms/bureaucracy
...
Every question MUST include ALL four components:
...
**Purpose:** Signals that you care, that their story matters.
...
**Keep it simple:** One question at a time, clearly stated.

### Component 3: Permission
...
**Purpose:** Removes performance pressure. They can contribute even if uncertain.

### Component 4: Gratitude
...
**Purpose:** Positive reinforcement. Makes them want to share more.
...
- ✅ Gratitude: "Thank you for sharing what you do remember!"
...
- ✅ Gratitude: "Thank you for trusting us with these memories"

**Note:** Extra care with sensitive topics. Permission is critical.
...
- ✅ Gratitude: "Thank you for sharing this piece of family history!"
...
**Why bad:** Feels like talking to a database, not a person.
...
**Why bad:** Creates performance pressure, makes sharing feel obligatory.
...
**Why bad:** Doesn't value their contribution. Feels transactional.
...
**Why bad:** Makes them defensive. Discourages future sharing.

**Note:** Conflicts are preserved, NEVER pointed out to the family this way.
...
Message 3: "Thank you for sharing! If you remember..."
```

**Why bad:** Becomes robotic through repetition.

**Fix:** Vary the language while maintaining components.

```
Message 1: "Thank you for sharing! If you remember..."
Message 2: "I appreciate this memory! Do you happen to recall..."
Message 3: "What a beautiful detail! If it comes to mind..."
```
...
**Why bad:** Over-the-top. Feels fake. No actual question or substance.
...
**Why bad:** Cold opening, grudging permission.
...
- Building trust for sensitive topics
...
5. **NEVER judge** - Accept all memories as valid
6. **ADAPT to culture** - Same warmth, different expression

These are not suggestions. These are requirements.

Warmth is the product.
